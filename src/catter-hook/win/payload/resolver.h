...
template <>
constexpr inline std::basic_string_view<char> k_path_env_name<char> = "PATH";

template <>
constexpr inline std::basic_string_view<wchar_t> k_path_env_name<wchar_t> = L"PATH";

template <CharT char_t>
constexpr std::basic_string_view<char_t> k_system16_name = {};

template <>
constexpr inline std::basic_string_view<char> k_system16_name<char> = "System";

template <>
constexpr inline std::basic_string_view<wchar_t> k_system16_name<wchar_t> = L"System";
